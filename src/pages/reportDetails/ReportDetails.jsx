...
const ReportDetails = () => {
  ...
  const triggerAnalysisIfNeeded = async (reportData) => {
    if (reportData.needsAnalysis) {
        ...
        setTimeout(async () => {
          ...
          if (result.success && result.needsQuestions) {
            ...
            const response = await fetch(
              `https://jansamadhan-json-server.onrender.com/complaints/${reportId}`
            );
      ...
      if (
        reportData.aiAnalysis.needsQuestions &&
        reportData.aiAnalysis.questions?.length > 0
      ) {
            ...
            <div className="flex items-start space-x-3">
              ...
              <div className="flex-1">
                ...
                <p className="text-sm text-amber-700 mb-4">
                  To better process your report, please answer the following
                  questions:
                </p>
                ...
                <div className="bg-white rounded-lg p-4 border">
                  ...
                  <textarea
                    ...
                    value={
                      questionAnswers[questions[currentQuestionIndex]] || ""
                    }
                    onChange={(e) => {
                      setQuestionAnswers((prev) => ({
                        ...prev,
            ...
            <div className="flex items-center space-x-3">
              ...
              <div>
                ...
                <p className="text-sm text-green-700">
                  Thank you for providing additional information. This will help
                  us process your report more efficiently.
                </p>
              </div>
            </div>
          </div>
